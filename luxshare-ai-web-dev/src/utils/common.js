...
export const FileModel = {
  PERSONAL: KnowledgeSelect.PERSONAL,     // 个人知识库内容
  PUBLIC: KnowledgeSelect.PUBLIC,         // 公用知识库内容
  DEPARTMENT: KnowledgeSelect.DEPARTMENT, // 部门知识库内容
  EMPTY: 0                                // 空文件夹提示
};
...
export const getFileImgByExtension = (file) => {
  if (file.fileUrl && pictureTypes.includes(file.extension)) {
    return file.fileUrl;
  }
...
export const getTextAfterLastDot = fileName => {
