...
/**
 * 文件格式转换策略模式具体实现 - 转换为pptx.
 * @author 10353965
 */
@Component
public class PptxConverterStrategy implements FileConvertStrategy {
    private static final Logger logger = LoggerFactory.getLogger(PptxConverterStrategy.class.getName());
    ...
    public boolean supports(String format) {
        return "pptx".equalsIgnoreCase(format);
    }
}
